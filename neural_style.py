...
def main():
    ...
    # print (style_images)
    # print ('style_images - ' + str(len(style_images)))
    # print ('style_images[0] - ' + str(len(style_images[0])))        #wysokość pierwszej foty stylu
    # print ('style_images[0][0] - ' + str(len(style_images[0][0])))  #szerokość pierwszej foty stylu
    # print ('style_images[1] - ' + str(len(style_images[1])))        #wysokość drugiej foty stylu
    # print ('style_images[1][0] - ' + str(len(style_images[1][0])))  #szerokość drugiej foty stylu

    # print( 'options.width - ' + str(options.width) )
    # print( 'content_image.shape[0] - ' + str(content_image.shape[0]) )
    # print( 'content_image.shape[1] - ' + str(content_image.shape[1]) )
    # print( 'options.style_scales - ' + str(options.style_scales) )
